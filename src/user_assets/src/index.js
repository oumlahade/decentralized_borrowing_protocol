...
// const user = Actor.createActor(user1_idl, { agent, canisterId: user1_id });
...
//    document.getElementById("accntResult").innerText = "Hello, Rhys";
// });

function accountFunction() {
  document.getElementById("demo").innerHTML = "Hello, Rhys";
}

function ICPFunction() {
  document.getElementById("balance").innerHTML = "10,000 ICP"
}
...
// document.getElementById("ICPButton").addEventListener("click", async () => {
//     const alert = await user1.get_Free_ICP().value.toString();
//     document.getElementById("balance").innerText = alert;
// });
